...
export interface StoryClosingProps {
    content?: Partial<typeof OUR_STORY_CONTENT.closing>;
}

export function StoryClosingSection({ content }: StoryClosingProps = {}) {
    ...
    const closing = {
        ...OUR_STORY_CONTENT.closing,
        ...content,
    };

    return (
        <section
            aria-label="Story Closing Statement"
        ...
        >
            ...
            <div className="absolute inset-0">
                <img
                    src={OUR_STORY_IMAGES.closing.src}
                    alt={OUR_STORY_IMAGES.closing.alt}
                    loading="lazy"
                    decoding="async"

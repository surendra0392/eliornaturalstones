        ...
        <PublicLayout>
            <SeoHead
                ...
                keywords={[
                    ...
                    'marble slabs hyderabad',
                    'markapuram slate stone andhra pradesh',
                    'markapur black slate tiles',
                    'tandur limestone flooring telangana',
                    'tandur blue yellow stone slabs',
                    'chimakurthy black galaxy granite',
                    'architectural granites hyderabad',
                    'natural stone suppliers in andhra pradesh',
                    'telangana natural stones',
                    'jubilee hills marble studio',
                    'banjara hills luxury stone flooring',
                    'gachibowli kokapet stone suppliers',
                    'prakasam district stone quarries',
                    'natural sandstone slabs india',

...
class UpdateVarietyRequest extends FormRequest
{
    ...
    {
        /** @var Variety|string|int|null $varietyParam */
        $varietyParam = $this->route('variety');
        $varietyId = $varietyParam instanceof Variety ? $varietyParam->id : $varietyParam;
        ...
        return [
            ...
            'slug' => [
                ...
                'alpha_dash',
                'max:255',
                Rule::unique('varieties', 'slug')->ignore($varietyId),
